> فرع تطوير **5.0.0**: التغييرات الحالية في [سجل التغييرات](CHANGELOG.md) و[حالة المميزات](docs/ROADMAP-5.x-features.md). أمثلة 4.0.1 أدناه تخص النسخة المنشورة السابقة. الديمو يحتوي الآن على Playground لتعديل الشكل ونسخ Kotlin وشاشة ضغط من 300 عنصر. نشر Maven Central يحتاج تجهيز مفاتيح التوقيع والتحقق من ملكية الحساب؛ تجهيز النشر لا يعني إن النسخة اتنشرت بالفعل.
...
## المطور والمسؤول الحالي عن الصيانة

**عبدالرحمن حسين (Abdelrahman Hussein / Obieda)** هو المطور والمسؤول الحالي عن صيانة وتطوير هذه النسخة من المكتبة.

مسؤول عن التطوير المستمر، والصيانة، والتحديثات، وتحسين الأداء، وإصلاح المشاكل، والاختبارات، والتحديثات المستقبلية والإصدارات الجديدة لهذه النسخة.

المشروع ده مبني على العمل الأصلي للمؤسسين والمساهمين في المشروع الأساسي، والفضل لهم في وضع الأساس الأول للمكتبة. حقوق ونسب العمل الأصلي محفوظة، والنسخة دي بتكمل تطوير المكتبة بعد فترة طويلة من محدودية الصيانة والتحديث، مع التركيز على Android الحديث، وJetpack Compose، والأداء، والاستقرار، وإمكانية الوصول، وسهولة الصيانة على المدى الطويل.
